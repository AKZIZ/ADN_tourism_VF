...
# chargement des donnees
    ...
    with zipfile.ZipFile(r"C:\Users\rachi\Desktop\Projet4\ADN_tourisme\ADN_tourism_VF\df_400POI_clean.zip") as z:
...
if selected == "HOME":
    ...
    # chargement des donnees
        ...
        with zipfile.ZipFile(r"C:\Users\rachi\Desktop\Projet4\ADN_tourisme\ADN_tourism_VF\df_400POI_2.zip") as z:
   # open the csv file in the dataset
