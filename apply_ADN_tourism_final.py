...
# chargement des donnees
    ...
    with zipfile.ZipFile("C:\Users\rachi\Desktop\Projet4\ADN_tourisme\df_400POI_clean.zip","r") as z:
...
if selected == "HOME":
    ...
    # chargement des donnees
        ...
        with zipfile.ZipFile("C:\Users\rachi\Desktop\Projet4\ADN_tourisme\df_400POI_2.zip","r") as z:
   # open the csv file in the dataset
